/**
 * Generic 'focus' component for frontend side application. Purpose of this component is to provide an easy way to
 * trigger focus to specified input whenever needed.
 *

/**
 * Generic data service to interact with Sails.js backend. This will just wrap $sailsSocket methods to a single service,
 * that is used from application.
 *
 * This is needed because we need to make some common url handling for sails endpoint. And if and when $sailsSocket is
 * changed to another one, basically all work is just in this service - or that is what I hope.
 */
(function() {
  'use strict';
